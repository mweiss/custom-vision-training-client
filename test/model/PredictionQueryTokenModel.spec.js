...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrainingApi.PredictionQueryTokenModel();
  });
  ...
  describe('PredictionQueryTokenModel', function() {
    it('should create an instance of PredictionQueryTokenModel', function() {
      // uncomment below and update the code to test PredictionQueryTokenModel
      //var instane = new TrainingApi.PredictionQueryTokenModel();
      //expect(instance).to.be.a(TrainingApi.PredictionQueryTokenModel);
    });
