...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrainingApi.KeyPairModel();
  });
  ...
  describe('KeyPairModel', function() {
    it('should create an instance of KeyPairModel', function() {
      // uncomment below and update the code to test KeyPairModel
      //var instane = new TrainingApi.KeyPairModel();
      //expect(instance).to.be.a(TrainingApi.KeyPairModel);
    });
